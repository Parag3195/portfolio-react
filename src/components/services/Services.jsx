        ...
        <div className="services_container container grid">
            <div className="services_content">
                ...
                <div className={toggleState ===1 ? "services_modal active-modal" : "services_modal" }>
                    ...
                    <p className="services_modal-description">Service with more than 6 months of experience. Providing quality work to clients.</p>
            ...
            <div className="services_content">
                ...
                <div className={toggleState === 2 ? "services_modal active-modal" : "services_modal" }>
                    ...
                    <p className="services_modal-description">Service with more than 6 months of experience.Providing quality work to clients and companies.</p>
