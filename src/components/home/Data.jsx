...
<div className="home_data">
    <h1 className="home_title">Parag Shinde
...
<p className="home_description">An enthusiastic fresher who is self-starter and capable to use
Technical skills for betterment of the organization.</p>
